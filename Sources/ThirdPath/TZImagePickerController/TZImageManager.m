...
- (void)setColumnNumber:(NSInteger)columnNumber {
    ...
    CGFloat totalAvailableWidth = TZScreenWidth - 2 * margin - 4;
    CGFloat itemWH = floor(totalAvailableWidth / columnNumber) - margin;
...
- (void)getCameraRollAlbumWithFetchAssets:(BOOL)needFetchAssets completion:(void (^)(TZAlbumModel *model))completion {
    ...
    // Unfiltered: always include both images and videos, do not set predicate by media type
...
- (TZAssetModel *)assetModelWithAsset:(PHAsset *)asset allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage {
    ...
    // Unfiltered: do not exclude assets by allowPicking flags
